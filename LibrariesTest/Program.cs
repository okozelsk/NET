...
namespace OKOSW.LibrariesTest
{
    class Program
    {
        ...
        {
            /*
            ESNDemoSettings myObject;
            // Construct an instance of the XmlSerializer with the type  
            // of object that is being deserialized.  
            XmlSerializer mySerializer = new XmlSerializer(typeof(ESNDemoSettings));
            // To read the file, create a FileStream.  
            FileStream myFileStream = new FileStream(@"C:\Users\OKOZELSK\_Data\Development\MSVCS\Projects\OKOSW\Demo\ESNDemo\ESNDemoSettings.xml", FileMode.Open);
            // Call the Deserialize method and cast to the object type.  
            myObject = (ESNDemoSettings)mySerializer.Deserialize(myFileStream);
            */
            ...
            EDUNetwork nn = new EDUNetwork(numInput, numHidden, numOutput);
            sw.Reset();
            sw.Start();
            ...
            int numRows, int seed)
        {
            ...
            EDUNetwork gnn = new EDUNetwork(numInput, numHidden, numOutput); // generating NN
