...
namespace Demo.DemoConsoleApp.Examples
{
    ...
    /// </summary>
    public class LibrasClassificationLSMDesignerVERTICAL : ExampleBase
    {
        /// <summary>
        ...
        public void Run()
        {
            ...
            InputEncoderSettings inputCfg = StateMachineDesigner.CreateInputCfg(new FeedingPatternedSettings(1, true, RCNet.Neural.Data.InputPattern.VariablesSchema.Groupped),
                                                                                new A2SCoderSettings(new A2SVerticalMethodSettings(8)),
                                                                                false,
            ...
            StateMachineSettings stateMachineCfg = smd.CreatePureLSMCfg(new ProportionsSettings(180, 1, 1), //Proportions (it also determines total size)
                                                                        ...
                                                                        new HomogenousExcitabilitySettings(0.5, 1, 0),
    ...
    }//LibrasClassificationLSMDesignerVERTICAL
