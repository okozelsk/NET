...
{
    /// <summary>
    /// Implements a set of routines common to all StateMachine-related code examples.
    /// </summary>
    public class StateMachineExampleBase : ExampleBase
    {
        //Constructor
        protected StateMachineExampleBase()
            :base()
        {
            return;
        }
