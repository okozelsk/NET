...
namespace Demo.DemoConsoleApp.Examples.SM
{
    ...
    /// </summary>
    public class Classification_LibrasMovement_NPBypass_SMD : StateMachineExampleBase
    {
        //Constructor
        public Classification_LibrasMovement_NPBypass_SMD()
            : base()
        {
            return;
        }
    ...
    }//Classification_LibrasMovement_NPBypass_SMD
