...
{
    /// <summary>
    /// Configuration of the A2SCoderUpDirArrows coder.
    /// </summary>
    [Serializable]
    public class A2SCoderUpDirArrowsSettings : RCNetBaseSettings
    {
        //Constants
        /// <summary>
        ...
        public A2SCoderUpDirArrowsSettings(int numOfReceptors = DefaultNumOfReceptors,
        ...
        public A2SCoderUpDirArrowsSettings(A2SCoderUpDirArrowsSettings source)
        ...
        public A2SCoderUpDirArrowsSettings(XElement elem)
        {
            //Validation
        ...
        {
            return new A2SCoderUpDirArrowsSettings(this);
        }
        ...
        {
            return GetXml("upDirArrowsCoder", suppressDefaults);
        }

    }//A2SCoderUpDirArrowsSettings
