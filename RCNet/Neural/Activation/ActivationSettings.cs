...
namespace RCNet.Neural.Activation
{
    ...
    public class ActivationSettings
    {
        ...
        /// </summary>
        public ActivationFactory.FunctionType FunctionType { get; set; }
        /// <summary>
        ...
        public ActivationSettings(ActivationFactory.FunctionType functionType,
        ...
        public Interval WorkingRange
        {
            get
            {
                IActivationFunction af = ActivationFactory.CreateActivationFunction(this);
                return af.Range;
            }
        }
