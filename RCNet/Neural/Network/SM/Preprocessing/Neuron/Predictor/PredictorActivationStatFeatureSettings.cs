...
{
    /// <summary>
    /// Configuration of the ActivationStatFeature predictor
    /// </summary>
    [Serializable]
    public class PredictorActivationStatFeatureSettings : RCNetBaseSettings, IPredictorSettings
    {
        //Constants
        /// <summary>
        /// Name of the associated xsd type
        /// </summary>
        public const string XsdTypeName = "PredictorActivationStatFeatureType";
        /// <summary>
        ...
        public PredictorActivationStatFeatureSettings(BasicStat.OutputFeature feature, int window = DefaultWindow)
        {
            Feature = feature;
            Window = window;
            Check();
        ...
        public PredictorActivationStatFeatureSettings(PredictorActivationStatFeatureSettings source)
        ...
        public PredictorActivationStatFeatureSettings(XElement elem)
        {
            //Validation
        ...
        /// ID of the predictor
        /// </summary>
        public PredictorsProvider.PredictorID ID { get { return PredictorsProvider.PredictorID.ActivationStatFeature; } }
        ...
        /// </summary>
        public bool NeedsContinuousActivationStat { get { return Window == NAWindowNum; } }
        ...
        {
            return new PredictorActivationStatFeatureSettings(this);
        }
    ...
    }//PredictorActivationStatFeatureSettings
