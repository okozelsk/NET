...
{
    /// <summary>
    /// Configuration of the ActivationStatFigure predictor computer.
    /// </summary>
    [Serializable]
    public class PredictorActivationStatFigureSettings : RCNetBaseSettings, IPredictorSettings
    {
        //Constants
        /// <summary>
        /// The name of the associated xsd type.
        /// </summary>
        public const string XsdTypeName = "PredictorActivationStatFigureType";
        /// <summary>
        ...
        public PredictorActivationStatFigureSettings(BasicStat.StatisticalFigure figure, int window = DefaultWindow)
        {
            Figure = figure;
            Window = window;
            Check();
        ...
        public PredictorActivationStatFigureSettings(XElement elem)
        {
            //Validation
        ...
        //Properties
        /// <inheritdoc/>
        public PredictorsProvider.PredictorID ID { get { return PredictorsProvider.PredictorID.ActivationStatFigure; } }
        ...
        {
            return new PredictorActivationStatFigureSettings(this);
        }
    ...
    }//PredictorActivationStatFigureSettings
