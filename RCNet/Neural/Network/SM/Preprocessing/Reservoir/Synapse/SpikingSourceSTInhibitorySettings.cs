...
{
    /// <summary>
    /// Configuration of an inhibitory synapse connecting presynaptic hidden spiking neuron and postsynaptic hidden spiking neuron.
    /// </summary>
    [Serializable]
    public class SpikingSourceSTInhibitorySettings : RCNetBaseSettings
    {
        //Constants
        /// <summary>
        /// The name of the associated xsd type.
        /// </summary>
        public const string XsdTypeName = "SynapseSpikingSourceSTInhibitoryType";
        ...
        /// </summary>
        public PlasticitySTInhibitorySettings PlasticityCfg { get; }
        ...
        public SpikingSourceSTInhibitorySettings(URandomValueSettings weightCfg = null,
                                                 PlasticitySTInhibitorySettings plasticityCfg = null
                                                 )
        {
            ...
            PlasticityCfg = plasticityCfg == null ? new PlasticitySTInhibitorySettings() : (PlasticitySTInhibitorySettings)plasticityCfg.DeepClone();
            Check();
            return;
        }
        ...
        public SpikingSourceSTInhibitorySettings(XElement elem)
        {
            //Validation
        ...
        {
            return new SpikingSourceSTInhibitorySettings(this);
        }
    ...
    }//SpikingSourceSTInhibitorySettings
