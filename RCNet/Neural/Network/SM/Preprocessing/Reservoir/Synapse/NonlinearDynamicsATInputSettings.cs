...
{
    /// <summary>
    /// Configuration of the efficacy's nonlinear dynamics of an input synapse connecting presynaptic input spiking neuron and postsynaptic hidden analog neuron.
    /// </summary>
    [Serializable]
