...
{
    /// <summary>
    /// Configuration of the efficacy's linear dynamics of an indifferent synapse connecting presynaptic hidden spiking neuron and postsynaptic hidden analog neuron.
    /// </summary>
    [Serializable]
