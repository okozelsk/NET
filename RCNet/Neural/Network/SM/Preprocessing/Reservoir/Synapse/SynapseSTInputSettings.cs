...
{
    /// <summary>
    /// Configuration parameters of a synapse providing input signal to hidden spiking neuron
    /// </summary>
    [Serializable]
    public class SynapseSTInputSettings : RCNetBaseSettings
    {
        //Constants
        /// <summary>
        /// Name of the associated xsd type
        /// </summary>
        public const string XsdTypeName = "SynapseSTInputType";
        ...
        /// </summary>
        public SpikingSourceSTInputSettings SpikingSourceCfg { get; }
        ...
        public SynapseSTInputSettings(Synapse.SynapticDelayMethod delayMethod = DefaultDelayMethod,
                                      int maxDelay = DefaultMaxDelay,
                                      AnalogSourceSettings analogSourceCfg = null,
                                      SpikingSourceSTInputSettings spikingSourceCfg = null
                                      )
        {
            DelayMethod = delayMethod;
            MaxDelay = maxDelay;
            AnalogSourceCfg = analogSourceCfg == null ? new AnalogSourceSettings() : (AnalogSourceSettings)analogSourceCfg.DeepClone();
            SpikingSourceCfg = spikingSourceCfg == null ? new SpikingSourceSTInputSettings() : (SpikingSourceSTInputSettings)spikingSourceCfg.DeepClone();
            Check();
            return;
        }
        ...
        public SynapseSTInputSettings(SynapseSTInputSettings source)
        ...
        public SynapseSTInputSettings(XElement elem)
        {
            //Validation
            ...
            SpikingSourceCfg = spikingSourceElem == null ? new SpikingSourceSTInputSettings() : new SpikingSourceSTInputSettings(spikingSourceElem);
            Check();
            return;
        }
        ...
        {
            return new SynapseSTInputSettings(this);
        }
