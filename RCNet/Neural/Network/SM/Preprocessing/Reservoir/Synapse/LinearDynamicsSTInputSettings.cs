...
{
    /// <summary>
    /// Configuration of the efficacy's linear dynamics of an input synapse connecting presynaptic input spiking neuron and postsynaptic hidden spiking neuron.
    /// </summary>
    [Serializable]
    public class LinearDynamicsSTInputSettings : LinearDynamicsSettings
    {
        //Constants
        /// <summary>
        /// The name of the associated xsd type.
        /// </summary>
        public const string XsdTypeName = "SynapseLinearDynamicsSTInputType";
        ...
        public LinearDynamicsSTInputSettings(double alpha = DefaultAlpha, double beta = DefaultBeta, double initialEfficacy = DefaultInitialEfficacy)
        ...
        public LinearDynamicsSTInputSettings(LinearDynamicsSTInputSettings source)
            : base(source)
        {
            return;
        }
        ...
        public LinearDynamicsSTInputSettings(XElement elem)
        ...
        {
            return new LinearDynamicsSTInputSettings(this);
        }
