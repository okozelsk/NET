...
namespace RCNet.Neural.Network.SM.Preprocessing.Reservoir.SynapseNS
{
    ...
    /// </summary>
    [Serializable]
    public class InternalWeightAASettings : URandomValueSettings
    {
        //Constants
        /// <summary>
        ...
        public InternalWeightAASettings(double min,
                                         double max,
        ...
        public InternalWeightAASettings(InternalWeightAASettings source)
            :base(source)
        {
            return;
        }
        ...
        public InternalWeightAASettings(XElement elem)
            :base(elem)
        {
            return;
        }
        ...
        {
            return new InternalWeightAASettings(this);
        }
        ...
        {
            return GetXml("weightAA", suppressDefaults);
        }

    }//InternalWeightAASettings
