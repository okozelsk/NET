...
{
    /// <summary>
    /// Configuration parameters of the synapse dynamics connecting Excitatory-Inhibitory neurons
    /// </summary>
    [Serializable]
    public class DynamicsEISettings : DynamicsSettings
    {
        //Constants
        /// <summary>
        /// Name of the associated xsd type
        /// </summary>
        public const string XsdTypeName = "SynapseDynamicsEIType";
        ...
        public DynamicsEISettings(double restingEfficacy = DefaultRestingEfficacy,
        ...
        public DynamicsEISettings(DynamicsEISettings source)
            :base(source)
        {
            return;
        }
        ...
        public DynamicsEISettings(XElement elem)
        ...
        {
            return new DynamicsEISettings(this);
        }
        ...
        {
            return GetXml("dynamicsEI", suppressDefaults);
        }
