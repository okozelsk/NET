...
{
    /// <summary>
    /// Configuration of the efficacy's constant dynamics of an excitatory synapse connecting presynaptic hidden spiking neuron and postsynaptic hidden spiking neuron.
    /// </summary>
    [Serializable]
