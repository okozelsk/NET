...
{
    /// <summary>
    /// Configuration of the efficacy's nonlinear dynamics of an excitatory synapse connecting presynaptic hidden spiking neuron and postsynaptic hidden spiking neuron.
    /// </summary>
    [Serializable]
