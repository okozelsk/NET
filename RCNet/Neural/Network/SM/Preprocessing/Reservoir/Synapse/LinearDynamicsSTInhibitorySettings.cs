...
{
    /// <summary>
    /// Configuration parameters of the synapse linear dynamics (inhibitory spiking to hidden spiking neuron)
    /// </summary>
    [Serializable]
    public class LinearDynamicsSTInhibitorySettings : LinearDynamicsSettings
    {
        ...
        {
            return new LinearDynamicsSTInhibitorySettings(this);
        }
    ...
    }//LinearDynamicsSTInhibitorySettings
