...
{
    /// <summary>
    /// Configuration parameters of the dynamics of a synapse connecting Analog-Excitatory and Spiking-Excitatory neurons
    /// </summary>
    [Serializable]
    public class A2SSynapseE2EDynamicsSettings : DynamicsSettings
    {
        //Constants
        /// <summary>
        /// Name of the associated xsd type
        /// </summary>
        public const string XsdTypeName = "A2SSynapseE2EDynamicsType";
        ...
        public A2SSynapseE2EDynamicsSettings(double restingEfficacy = DefaultRestingEfficacy,
        ...
        public A2SSynapseE2EDynamicsSettings(A2SSynapseE2EDynamicsSettings source)
            :base(source)
        {
            return;
        }
        ...
        /// </param>
        public A2SSynapseE2EDynamicsSettings(XElement elem)
        ...
        {
            return new A2SSynapseE2EDynamicsSettings(this);
        }
        ...
        {
            return GetXml("dynamicsA2SEE", suppressDefaults);
        }

    }//A2SSynapseE2EDynamicsSettings
