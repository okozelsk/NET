...
{
    /// <summary>
    /// Configuration parameters of the dynamics of a synapse connecting Spiking-Excitatory and Analog-Inhibitory neurons
    /// </summary>
    [Serializable]
    public class S2ASynapseE2IDynamicsSettings : DynamicsSettings
    {
        //Constants
        /// <summary>
        /// Name of the associated xsd type
        /// </summary>
        public const string XsdTypeName = "S2ASynapseE2IDynamicsType";
        ...
        public S2ASynapseE2IDynamicsSettings(double restingEfficacy = DefaultRestingEfficacy,
        ...
        public S2ASynapseE2IDynamicsSettings(S2ASynapseE2IDynamicsSettings source)
            :base(source)
        {
            return;
        }
        ...
        /// </param>
        public S2ASynapseE2IDynamicsSettings(XElement elem)
        ...
        {
            return new S2ASynapseE2IDynamicsSettings(this);
        }
        ...
        {
            return GetXml("dynamicsS2AEI", suppressDefaults);
        }

    }//S2ASynapseE2IDynamicsSettings
