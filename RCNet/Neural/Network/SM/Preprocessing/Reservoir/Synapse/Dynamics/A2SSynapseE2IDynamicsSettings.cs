...
{
    /// <summary>
    /// Configuration parameters of the dynamics of a synapse connecting Analog-Excitatory and Spiking-Inhibitory neurons
    /// </summary>
    [Serializable]
    public class A2SSynapseE2IDynamicsSettings : DynamicsSettings
    {
        //Constants
        /// <summary>
        /// Name of the associated xsd type
        /// </summary>
        public const string XsdTypeName = "A2SSynapseE2IDynamicsType";
        ...
        public A2SSynapseE2IDynamicsSettings(double restingEfficacy = DefaultRestingEfficacy,
        ...
        public A2SSynapseE2IDynamicsSettings(A2SSynapseE2IDynamicsSettings source)
            :base(source)
        {
            return;
        }
        ...
        /// </param>
        public A2SSynapseE2IDynamicsSettings(XElement elem)
        ...
        {
            return new A2SSynapseE2IDynamicsSettings(this);
        }
        ...
        {
            return GetXml("dynamicsA2SEI", suppressDefaults);
        }

    }//A2SSynapseE2IDynamicsSettings
