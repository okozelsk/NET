...
{
    /// <summary>
    /// Configuration parameters of the dynamics of a synapse connecting Spiking-Excitatory and Spiking-Excitatory neurons
    /// </summary>
    [Serializable]
    public class S2SSynapseE2EDynamicsSettings : DynamicsSettings
    {
        //Constants
        /// <summary>
        /// Name of the associated xsd type
        /// </summary>
        public const string XsdTypeName = "S2SSynapseE2EDynamicsType";
        ...
        public S2SSynapseE2EDynamicsSettings(double restingEfficacy = DefaultRestingEfficacy,
        ...
        public S2SSynapseE2EDynamicsSettings(S2SSynapseE2EDynamicsSettings source)
            :base(source)
        {
            return;
        }
        ...
        /// </param>
        public S2SSynapseE2EDynamicsSettings(XElement elem)
        ...
        {
            return new S2SSynapseE2EDynamicsSettings(this);
        }
        ...
        {
            return GetXml("dynamicsS2SEE", suppressDefaults);
        }

    }//S2SSynapseE2EDynamicsSettings
