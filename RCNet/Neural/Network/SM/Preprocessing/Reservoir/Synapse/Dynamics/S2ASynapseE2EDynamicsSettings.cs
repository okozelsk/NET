...
{
    /// <summary>
    /// Configuration parameters of the dynamics of a synapse connecting Spiking-Excitatory and Analog-Excitatory neurons
    /// </summary>
    [Serializable]
    public class S2ASynapseE2EDynamicsSettings : DynamicsSettings
    {
        //Constants
        /// <summary>
        /// Name of the associated xsd type
        /// </summary>
        public const string XsdTypeName = "S2ASynapseE2EDynamicsType";
        ...
        public S2ASynapseE2EDynamicsSettings(double restingEfficacy = DefaultRestingEfficacy,
        ...
        public S2ASynapseE2EDynamicsSettings(S2ASynapseE2EDynamicsSettings source)
            :base(source)
        {
            return;
        }
        ...
        /// </param>
        public S2ASynapseE2EDynamicsSettings(XElement elem)
        ...
        {
            return new S2ASynapseE2EDynamicsSettings(this);
        }
        ...
        {
            return GetXml("dynamicsS2AEE", suppressDefaults);
        }

    }//S2ASynapseE2EDynamicsSettings
