...
{
    /// <summary>
    /// Configuration parameters of the dynamics of a synapse connecting Analog-Inhibitory and Analog-Excitatory neurons
    /// </summary>
    [Serializable]
    public class A2ASynapseI2EDynamicsSettings : DynamicsSettings
    {
        //Constants
        /// <summary>
        /// Name of the associated xsd type
        /// </summary>
        public const string XsdTypeName = "A2ASynapseI2EDynamicsType";
        ...
        public A2ASynapseI2EDynamicsSettings(double restingEfficacy = DefaultRestingEfficacy,
        ...
        public A2ASynapseI2EDynamicsSettings(A2ASynapseI2EDynamicsSettings source)
            :base(source)
        {
            return;
        }
        ...
        /// </param>
        public A2ASynapseI2EDynamicsSettings(XElement elem)
        ...
        {
            return new A2ASynapseI2EDynamicsSettings(this);
        }
        ...
        {
            return GetXml("dynamicsA2AIE", suppressDefaults);
        }

    }//A2ASynapseI2EDynamicsSettings
