...
{
    /// <summary>
    /// Configuration parameters of the dynamics of a synapse connecting Analog-Inhibitory and Spiking-Inhibitory neurons
    /// </summary>
    [Serializable]
    public class A2SSynapseI2IDynamicsSettings : DynamicsSettings
    {
        //Constants
        /// <summary>
        /// Name of the associated xsd type
        /// </summary>
        public const string XsdTypeName = "A2SSynapseI2IDynamicsType";
        ...
        public A2SSynapseI2IDynamicsSettings(double restingEfficacy = DefaultRestingEfficacy,
        ...
        public A2SSynapseI2IDynamicsSettings(A2SSynapseI2IDynamicsSettings source)
            :base(source)
        {
            return;
        }
        ...
        /// </param>
        public A2SSynapseI2IDynamicsSettings(XElement elem)
        ...
        {
            return new A2SSynapseI2IDynamicsSettings(this);
        }
        ...
        {
            return GetXml("dynamicsA2SII", suppressDefaults);
        }

    }//A2SSynapseI2IDynamicsSettings
