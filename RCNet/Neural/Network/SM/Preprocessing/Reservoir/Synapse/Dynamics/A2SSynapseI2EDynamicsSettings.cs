...
{
    /// <summary>
    /// Configuration parameters of the dynamics of a synapse connecting Analog-Inhibitory and Spiking-Excitatory neurons
    /// </summary>
    [Serializable]
    public class A2SSynapseI2EDynamicsSettings : DynamicsSettings
    {
        //Constants
        /// <summary>
        /// Name of the associated xsd type
        /// </summary>
        public const string XsdTypeName = "A2SSynapseI2EDynamicsType";
        ...
        public A2SSynapseI2EDynamicsSettings(double restingEfficacy = DefaultRestingEfficacy,
        ...
        public A2SSynapseI2EDynamicsSettings(A2SSynapseI2EDynamicsSettings source)
            :base(source)
        {
            return;
        }
        ...
        /// </param>
        public A2SSynapseI2EDynamicsSettings(XElement elem)
        ...
        {
            return new A2SSynapseI2EDynamicsSettings(this);
        }
        ...
        {
            return GetXml("dynamicsA2SIE", suppressDefaults);
        }

    }//A2SSynapseI2EDynamicsSettings
