...
{
    /// <summary>
    /// Configuration parameters of the dynamics of a synapse connecting Analog-Excitatory and Analog-Excitatory neurons
    /// </summary>
    [Serializable]
    public class A2ASynapseE2EDynamicsSettings : DynamicsSettings
    {
        //Constants
        /// <summary>
        /// Name of the associated xsd type
        /// </summary>
        public const string XsdTypeName = "A2ASynapseE2EDynamicsType";
        ...
        public A2ASynapseE2EDynamicsSettings(double restingEfficacy = DefaultRestingEfficacy,
        ...
        public A2ASynapseE2EDynamicsSettings(A2ASynapseE2EDynamicsSettings source)
            :base(source)
        {
            return;
        }
        ...
        /// </param>
        public A2ASynapseE2EDynamicsSettings(XElement elem)
        ...
        {
            return new A2ASynapseE2EDynamicsSettings(this);
        }
        ...
        {
            return GetXml("dynamicsA2AEE", suppressDefaults);
        }

    }//A2ASynapseE2EDynamicsSettings
