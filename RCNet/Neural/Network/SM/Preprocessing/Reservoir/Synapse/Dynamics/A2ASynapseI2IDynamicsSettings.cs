...
{
    /// <summary>
    /// Configuration parameters of the dynamics of a synapse connecting Analog-Inhibitory and Analog-Inhibitory neurons
    /// </summary>
    [Serializable]
    public class A2ASynapseI2IDynamicsSettings : DynamicsSettings
    {
        //Constants
        /// <summary>
        /// Name of the associated xsd type
        /// </summary>
        public const string XsdTypeName = "A2ASynapseI2IDynamicsType";
        ...
        public A2ASynapseI2IDynamicsSettings(double restingEfficacy = DefaultRestingEfficacy,
        ...
        public A2ASynapseI2IDynamicsSettings(A2ASynapseI2IDynamicsSettings source)
            :base(source)
        {
            return;
        }
        ...
        /// </param>
        public A2ASynapseI2IDynamicsSettings(XElement elem)
        ...
        {
            return new A2ASynapseI2IDynamicsSettings(this);
        }
        ...
        {
            return GetXml("dynamicsA2AII", suppressDefaults);
        }

    }//A2ASynapseI2IDynamicsSettings
