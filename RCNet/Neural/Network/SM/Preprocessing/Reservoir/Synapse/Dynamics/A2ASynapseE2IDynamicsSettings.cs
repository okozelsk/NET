...
{
    /// <summary>
    /// Configuration parameters of the dynamics of a synapse connecting Analog-Excitatory and Analog-Inhibitory neurons
    /// </summary>
    [Serializable]
    public class A2ASynapseE2IDynamicsSettings : DynamicsSettings
    {
        //Constants
        /// <summary>
        /// Name of the associated xsd type
        /// </summary>
        public const string XsdTypeName = "A2ASynapseE2IDynamicsType";
        ...
        public A2ASynapseE2IDynamicsSettings(double restingEfficacy = DefaultRestingEfficacy,
        ...
        public A2ASynapseE2IDynamicsSettings(A2ASynapseE2IDynamicsSettings source)
            :base(source)
        {
            return;
        }
        ...
        /// </param>
        public A2ASynapseE2IDynamicsSettings(XElement elem)
        ...
        {
            return new A2ASynapseE2IDynamicsSettings(this);
        }
        ...
        {
            return GetXml("dynamicsA2AEI", suppressDefaults);
        }

    }//A2ASynapseE2IDynamicsSettings
