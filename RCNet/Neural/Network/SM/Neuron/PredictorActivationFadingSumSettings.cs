...
namespace RCNet.Neural.Network.SM.Neuron
{
    ...
    /// </summary>
    public class PredictorActivationFadingSumSettings : RCNetBaseSettings, IPredictorParamsSettings
    {
        //Constants
        /// <summary>
        /// Name of the associated xsd type
        /// </summary>
        public const string XsdTypeName = "PredictorActivationFadingSumCfgType";
        /// <summary>
        ...
        public PredictorActivationFadingSumSettings(double strength = DefaultStrength)
        {
            Strength = strength;
            Check();
            return;
        ...
        public PredictorActivationFadingSumSettings(PredictorActivationFadingSumSettings source)
        {
        ...
        public PredictorActivationFadingSumSettings(XElement elem)
        {
            //Validation
        ...
        /// ID of the predictor
        /// </summary>
        public Predictors.PredictorID ID { get { return Predictors.PredictorID.ActivationFadingSum; } }
        ...
        {
            return new PredictorActivationFadingSumSettings(this);
        }
