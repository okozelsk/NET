...
namespace RCNet.Neural.Network.SM.Neuron
{
    ...
    /// </summary>
    public class PredictorFiringFadingSumSettings : RCNetBaseSettings, IPredictorParamsSettings
    {
        //Constants
        /// <summary>
        /// Name of the associated xsd type
        /// </summary>
        public const string XsdTypeName = "PredictorFiringFadingSumCfgType";
        /// <summary>
        ...
        public PredictorFiringFadingSumSettings(double strength = DefaultStrength)
        {
            Strength = strength;
            Check();
            return;
        ...
        public PredictorFiringFadingSumSettings(PredictorFiringFadingSumSettings source)
        {
        ...
        public PredictorFiringFadingSumSettings(XElement elem)
        {
            //Validation
        ...
        /// ID of the predictor
        /// </summary>
        public Predictors.PredictorID ID { get { return Predictors.PredictorID.FiringFadingSum; } }
        ...
        {
            return new PredictorFiringFadingSumSettings(this);
        }
