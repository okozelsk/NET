...
namespace RCNet.Neural.Network.SM.Neuron
{
    ...
    /// </summary>
    public abstract class PredictorMWAvgSettings : RCNetBaseSettings
    {
        //Constants
        /// <summary>
        /// Name of the associated xsd type
        /// </summary>
        public const string XsdTypeName = "PredictorMWAvgCfgType";
        /// <summary>
        ...
        public PredictorMWAvgSettings(int window = DefaultWindow,
        ...
        public PredictorMWAvgSettings(PredictorMWAvgSettings source)
        {
        ...
        public PredictorMWAvgSettings(XElement elem)
        {
            //Validation
