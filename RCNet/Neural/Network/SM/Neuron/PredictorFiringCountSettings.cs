...
namespace RCNet.Neural.Network.SM.Neuron
{
    ...
    /// </summary>
    public class PredictorFiringCountSettings : RCNetBaseSettings, IPredictorParamsSettings
    {
        //Constants
        /// <summary>
        /// Name of the associated xsd type
        /// </summary>
        public const string XsdTypeName = "PredictorFiringCountCfgType";
        /// <summary>
        ...
        public PredictorFiringCountSettings(int window = DefaultWindow)
        {
            Window = window;
            Check();
            return;
        ...
        public PredictorFiringCountSettings(PredictorFiringCountSettings source)
        {
        ...
        public PredictorFiringCountSettings(XElement elem)
        {
            //Validation
        ...
        //Properties
        public Predictors.PredictorID ID { get { return Predictors.PredictorID.FiringCount; } }
        ...
        {
            return new PredictorFiringCountSettings(this);
        }
