...
namespace RCNet.Neural.Analog.Network.FF
{
    /// <summary>
    ...
    public class FeedForwardNetworkSettings
    {
        ...
        /// </summary>
        public AnalogActivationSettings OutputLayerActivation { get; set; }
        /// <summary>
        ...
        public class HiddenLayerSettings
        {
            ...
            /// </summary>
            public AnalogActivationSettings Activation { get; set; }
            ...
            public HiddenLayerSettings(XElement elem)
            {
                ...
                Activation = new AnalogActivationSettings(elem.Descendants("activation").First());
                return;
            }
