...
using RCNet.Neural.Analog.Network.FF;
using RCNet.Neural.Analog.Network.PP;
using RCNet.XmlTools;

namespace RCNet.Neural.Analog.Readout
{
    /// <summary>
    ...
    public class ReadoutLayerSettings
    {
        ...
        public ReadoutLayerSettings(XElement elem)
        {
            ...
            validator.AddXsdFromResources(assemblyRCNet, "RCNet.Neural.Analog.Readout.ReadoutLayerSettings.xsd");
